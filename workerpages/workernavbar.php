...
<head>
    ...
    <link rel="stylesheet" href="../css/workerdashboard-styles.css">
...
<header>
    ...
    <div id="menu">
        <h2>Comp<span>lainIT</span></h2>
        <ul>
            <li><a href="./workerdashboard.php" class="nav-link">Dashboard</a></li>
            <li><a href="./workerhistory.php" class="nav-link">History</a></li>

...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    if(isset($_POST["signup"])){
        ...
        $query="SELECT * FROM admins WHERE email='$email' OR phoneNos='$phone' OR adminId='$id'";
        $result=mysqli_query($conn,$query);

        if(mysqli_num_rows($result)==0){
            $password= password_hash($password, PASSWORD_DEFAULT);
            $query= "INSERT INTO admins (adminId,fullName,email,phoneNos,`password`) VALUES ('$id','$fname' ,'$email','$phone','$password')";
...
<head>
    ...
    <link rel="stylesheet" href="../css/adminsignuppage-styles.css">
</head>
<body>
    ...
    <div id="errorMessage2"><?php echo $error?></div>
        <fieldset>
            ...
            <label for="2">Admin ID:</label>
            <input type="text" required name="id" maxlength="7" minlength="7" placeholder="0988/23" id="2" value="<?php echo $id?>">
